...
export default function Pagination({ currentPage, totalPages }: Props) {
  ...
  return (
    <ReactPaginate
      ...
      previousLinkClassName='duration-300 rounded-full aspect-square h-10 flex justify-center items-center mx-7 opacity-100 hover:bg-neutral-700'
      nextLinkClassName='duration-300 rounded-full aspect-square h-10 flex justify-center items-center mx-7 opacity-100 hover:bg-neutral-700'
